...
assert.equal(sources.sources.length, 20);
...
assert.match(html, /data-category="codex">Codex<\/button>\s+<button class="segment-button" type="button" data-category="plus">仅Plus<\/button>\s+<button class="segment-button" type="button" data-category="sms">接码<\/button>/);
assert.match(html, /data-category="sms">接码<\/button>/);
assert.doesNotMatch(html, /一级标签/);
assert.doesNotMatch(html, /二级标签/);
assert.doesNotMatch(html, /显示设置/);
assert.match(html, /id="subtype-free"/);
assert.match(html, /value="free"/);
assert.match(html, /value="plus"/);
assert.match(html, /value="pro"/);
assert.match(html, /value="codex_sms"/);
...
assert.match(app, /selectedSubtypes/);
assert.match(app, /setSubtypeSelection/);
assert.match(app, /hasExactSubtypeSelection/);
assert.match(app, /setSubtypeSelection\(\[\]\)/);
assert.match(app, /visibleSubtypeValues/);
assert.match(app, /themeToggle/);
assert.match(app, /localStorage\.setItem\("color-theme"/);
assert.match(app, /plus: \["plus"\]/);
...
assert.match(sourcesHtml, /返回商品页/);
