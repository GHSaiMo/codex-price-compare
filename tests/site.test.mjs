...
assert.doesNotMatch(adminHtml, /id="stockWatchTarget"/);
assert.doesNotMatch(adminHtml, /id="stockWatchDigest"/);
assert.doesNotMatch(adminHtml, /每日摘要/);
assert.doesNotMatch(adminHtml, /到价阈值/);
...
assert.match(adminApp, /stockWatchStatus\.textContent = ""/);
